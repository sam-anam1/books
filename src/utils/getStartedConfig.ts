      ...
      items: [
        {
          ...
          documentation: 'https://www.sams-tech.net/books/chart-of-accounts',
        },
        {
          ...
          documentation: 'https://www.sams-tech.net/books/setup-opening-balances',
        },
        {
          key: 'Add Taxes',
          label: t`Add Taxes`,
          ...
          documentation:
            'https://www.sams-tech.net/books/create-initial-entries#add-taxes',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          documentation:
            'https://www.sams-tech.net/books/create-initial-entries#add-sales-items',
        },
        {
          key: 'Add Customers',
          ...
          documentation:
            'https://www.sams-tech.net/books/create-initial-entries#add-customers',
        },
        {
          ...
          documentation: 'https://www.sams-tech.net/books/sales-invoices',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          documentation:
            'https://www.sams-tech.net/books/purchase-invoices#creating-purchase-invoices',
        },
      ],
    },
  ];
